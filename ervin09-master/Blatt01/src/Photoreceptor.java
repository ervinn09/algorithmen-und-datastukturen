...
public class Photoreceptor extends Neuron {
	 ...
	 *
	 * Erzeugt Photoreceptor Objekt, ein Neuron mit gegebenem Index
	 * und Typ.Wirft RuntimeException, wenn der Rezeptortyp nicht
	 * green, blue oder red ist.
	 *
	 * @param index
	 *            index of the neuron
	 * @param type
	...
	public Photoreceptor(int index, String type) {
	  ...
	  if (!this.type.equals("green") && !this.type.equals("blue") && !this.type.equals("red")){
		  throw new RuntimeException ("non-existing type of receptor");
	  }
	  /*if (!type.equals("blue")){
	  	throw new RuntimeException("non-existing type of receptor");
	  }
	...
	public void addSynapse(Synapse synapse) {
		...
		if (outgoingsynapses.size()>1){
           throw new RuntimeException("more than one outgoing synapse");
		}
	}
